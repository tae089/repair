...
<body>
  ...
  <ul class="nav nav-tabs">
    ...
    <li>
    <a href="#all_detail" data-toggle="tab">รายละเอียด</a>
    </li>
    ...
    <div class="tab-pane fade " id="all_detail"><br />
      <div class="panel panel-primary">
        <div class="panel-heading">
          รายละเอียด<?php echo ($card_detail->card_type==1)? 'ที่ขอซื้อ': 'ที่ขอซ่อม'; ?>
        </div>
        <div class="panel-body">
          <div class="row form-group">
            <div class="col-md-3"><strong>รหัส<?php echo ($card_detail->card_type==1)? 'ซื้อ': 'การส่งซ่อม/เคลม'; ?></strong></div>
            <div class="col-md-3">
                <?php echo @$card_detail->card_code;?>
            </div>
