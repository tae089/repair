...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-edit fa-fw"></i> เพิ่มรายการสั่งซื้อ [
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <div class="row form-group">
            <div class="col-md-3"><strong>รหัสการสั่งซื้อ</strong></div>
            <div class="col-md-3">
        ...
        <div class="row form-group">
            <div class="col-md-3"><strong>ชื่อผู้สั่งซื้อ</strong></div>
            <div class="col-md-3">
        ...
        <div class="table-responsive">
            <table width="100%" class="table table-bordered">
                <tr>
                    ...
                    <td width="44%"><label for="item_note">สาเหตุที่สั่งซื้อ</label>
        ...
        $.post('card/save_confirm_card.php', queryString, (response) => {
          ...
          if(obj.satuts===true){
            ...
            setTimeout(() => { 
              ...
              window.location="?p=card_buys_all";
            }, 3000);
