<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header"><i class="fa fa-list fa-fw"></i> รายการสั่งซื้อ</h1>
  </div>
</div>
<ol class="breadcrumb">
  <li><a href="index.php">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">สถานะการสั่งซื้อ <span class="caret"></span></a>
...
<script  type="text/javascript">
  ...
  $(document).ready(() => { 
    ...
    $.post( "card/get_card_buy.php", (data) => {
        console.log(data);
