  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <div class="form-group">
        ...
        <input type="text" name="edit_access_title" id="edit_access_title" class="form-control" value="<?php echo @$getaccess_detail->access_name;?>"
          autofocus>
      </div>
      <div class="form-group">
...
<div class="panel panel-default">
  ...
  ?>
        <tr id="<?php echo @$showaccess->access_key;?>">
          ...
          <td align="center">
            <?php echo @$showaccess->access_key;?>
          </td>
          <td>&nbsp;<span data-toggle="tooltip" data-placement="right" title="<?php echo $showaccess->access_detail;?>">
              <?php echo @$showaccess->access_name;?></span></td>
          <td align="center" valign="middle">
            <?php echo @number_format($getdata->my_sql_show_rows("access_user","access_key='".$showaccess->access_key."'"));?>
          </td>
          <td align="center" valign="middle">
            <?php
	  ...
	  ?>
            <a href="?p=administrator_access_list&e=y&key=<?php echo @$showaccess->access_key;?>" type="button" class="btn btn-info btn-xs"><i
                class="fa fa-edit"></i> แก้ไข</a><button type="button" class="btn btn-danger btn-xs" onClick="javascript:deleteUnit('<?php echo @$showaccess->access_key;?>');"><i
                class="glyphicon glyphicon-remove"></i> ลบ</button></td>
        </tr>
        <?php
  }
  ?>
