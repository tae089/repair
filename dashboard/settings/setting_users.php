<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header"><i class="fa fa-user fa-fw"></i>
      <?php echo @LA_LB_SYSTEM_USER;?>
    </h1>
  </div>
</div>
<ol class="breadcrumb">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">
            <?php echo @LA_LB_INSERT_USER_DATA;?>
          </h4>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label for="name">
              <?php echo @LA_LB_NAME;?></label>
            <input type="text" name="name" id="name" class="form-control">
          </div>
          <div class="form-group">
            <label for="lastname">
              <?php echo @LA_LB_LASTNAME;?></label>
            <input type="text" name="lastname" id="lastname" class="form-control">
          </div>
          <div class="form-group">
            <label for="username">
              <?php echo @LA_LB_USERNAME;?></label>
            <input type="text" name="username" id="username" class="form-control">
          </div>
          <div class="form-group">
            <label for="password">
              <?php echo @LA_LB_PASSWORD;?></label>
            <input type="password" name="password" id="password" class="form-control">
          </div>
          <div class="form-group">
            <label for="repassword">
              <?php echo @LA_LB_PASSWORD_AGAIN;?></label>
            <input type="password" name="repassword" id="repassword" class="form-control">
          </div>
          <div class="form-group">
            <label for="email">
              <?php echo @LA_LB_EMAIL;?></label>
            <input type="email" name="email" id="email" class="form-control">
          </div>

          <div>
            <div class="form-group">
              <label for="work_group">
                <?php echo @LA_LB_GROUP;?></label>
              <select name="group" id="group" class="form-control" onchange="javascript:changWorking();">
                <option value="">
                  <?php echo "เลือก"; ?>
                </option>
                <?php 
                     $get_group = $getdata->my_sql_select(NULL,"work_group",NULL);
                      while ($get_resutl = mysql_fetch_object($get_group)) {
                        echo "<option value=".$get_resutl->group_id.">".$get_resutl->group_name."</option>";
                      }
                   ?>
              </select>
              </label>
          ...
          <div>
            <div class="form-group">
              <label for="work_group">
                <?php echo @LA_LB_GROUP_WORK;?></label>
          ...
          <div class="form-group">
            <label for="user_status">
              <?php echo @LA_LB_STATUS;?></label>
            <select name="user_status" id="user_status" class="form-control">
              <option value="1" selected="selected">
                <?php echo @LA_BTN_SHOW;?>
              </option>
              <option value="0">
                <?php echo @LA_BTN_HIDE;?>
              </option>
            </select>
          </div>
        </div>
...
<?php
  echo @$alert;
  ?>
<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus fa-fw"></i>
  <?php echo @LA_LB_NEW_USER;?></button>
<br /><br />
<?php
...
<form id="form2" name="form2" method="post">
  <div class="panel panel-info">
    <div class="panel-heading">
      <?php echo @LA_LB_EDIT_USER;?>
    </div>
    <div class="panel-body">
      <table width="100%" border="0">
        <tr>
          <td width="28%">
            <?php echo @LA_LB_USERNAME;?>
          </td>
          <td width="72%">
            <div class="form-group">
              <input name="edit_username" type="text" disabled="disabled" id="edit_username" value="<?php echo @$getuser_detail->username;?>"
        ...
        <tr>
          ...
          <td>
            <div class="form-group">
              <input type="text" name="edit_name" id="edit_name" class="form-control" value="<?php echo @$getuser_detail->name;?>"></div>
          </td>
        </tr>
        <tr>
          <td>
            <?php echo @LA_LB_LASTNAME;?>
          </td>
          <td>
            <div class="form-group">
              <input type="text" name="edit_lastname" id="edit_lastname" class="form-control" value="<?php echo @$getuser_detail->lastname;?>"></div>
          </td>
        </tr>
        <tr>
          <td>
            <?php echo @LA_LB_EMAIL;?>
          </td>
          <td>
            <div class="form-group">
              <input type="email" name="edit_email" id="edit_email" class="form-control" value="<?php echo @$getuser_detail->email;?>"></div>
          </td>
        </tr>
        <tr>
          <td colspan="2">
        ...
        <tr>
          <td>
            <?php echo @LA_LB_NEW_PASSWORD;?>
          </td>
          <td>
            <div class="form-group">
              <input type="password" name="edit_password" id="edit_password" class="form-control"></div>
          </td>
        </tr>
        <tr>
          <td>
            <?php echo @LA_LB_NEW_PASSWORD_AGAIN;?>
          </td>
          <td>
            <div class="form-group">
              <input type="password" name="edit_repassword" id="edit_repassword" class="form-control"></div>
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
    ...
    <div class="panel-footer">
      <button type="submit" name="edit_user_info" class="btn btn-info btn-sm"><i class="fa fa-save fa-fw"></i>
        <?php echo @LA_BTN_SAVE;?></button>
    </div>
  </div>
</form>
      ...
      <table width="100%" border="0" class="table table-bordered table-hover">
        <thead>
          <tr style="color:#FFF">
            ...
            <th width="8%" align="center" bgcolor="#5fb760">
              <?php echo @LA_LB_PHOTO;?>
            </th>
            <th width="30%" align="center" bgcolor="#5fb760">
              <?php echo @LA_LB_NAME;?>
            </th>
            <th width="27%" align="center" bgcolor="#5fb760">
              <?php echo @LA_LB_USERNAME;?>
            </th>
            <th width="32%" align="center" bgcolor="#5fb760">
              <?php echo @LA_LB_MANAGE;?>
            </th>
          </tr>
        </thead>
        <tbody>
   ...
   $l=0;
	   ...
	   ?>
          <tr id="<?php echo @$showalluser->user_key;?>">
            ...
            <td align="center">
              <div class="box_img_cycle3"><img src="../resource/users/thumbs/<?php echo @$showalluser->user_photo;?>"
                  <?php echo getPhotoSize('../resource/users/thumbs/'.@$showalluser->user_photo.'');?> id="img_cycle3"
                  alt="" /></div>
            </td>
            <td>&nbsp;<span style="font-size:12px; <?php echo $color;?>"><i class="fa fa-circle fa-fw"></i></span>&nbsp;
              <?php echo @$showalluser->name."&nbsp;&nbsp;&nbsp;".$showalluser->lastname;?>
            </td>
            <td align="center">
              <?php echo @$showalluser->username;?>
            </td>
            <td align="center">
              <?php
	  ...
	  ?><a
                href="?p=setting_users&e=y&key=<?php echo @$showalluser->user_key;?>" class="btn btn-info btn-xs "><i
                  class="fa fa-edit fa-fw"></i>
                <?php echo @LA_BTN_EDIT;?></a>
              <!--<a href="?p=setting_user_access&key=<?php echo @$showalluser->user_key;?>" class="btn btn-primary btn-xs " ><i class="fa fa-gear fa-fw"></i><?php echo @LA_BTN_ACCESS;?></a>--><button
                type="button" class="btn btn-danger btn-xs " onClick="javascript:deleteUser('<?php echo @$showalluser->user_key;?>');"><i
                  class="fa fa-times fa-fw"></i>
                <?php echo @LA_BTN_DELETE;?></button></td>
          </tr>
          <?php
	   }
   ?>
      ...
      <table width="100%" border="0" class="table table-bordered table-hover">
        <thead>
          <tr style="color:#FFF">
            ...
            <th width="6%" align="center" bgcolor="#5fb760">
              <?php echo @LA_LB_PHOTO;?>
            </th>
            <th width="28%" align="center" bgcolor="#5fb760">
              <?php echo @LA_LB_NAME;?>
            </th>
            <th width="22%" align="center" bgcolor="#5fb760">
              <?php echo @LA_LB_USERNAME;?>
            </th>
            <th width="26%" align="center" bgcolor="#5fb760">
              <?php echo @LA_LB_MANAGE;?>
            </th>
          </tr>
        </thead>
   ...
   $l=0;
	   ...
	   ?>
          <tr id="<?php echo @$showalluser->user_key;?>">
            ...
            <td align="center">
              <div class="box_img_cycle3"><img src="../resource/members/thumbs/<?php echo @$showalluser->user_photo;?>"
                  <?php echo getPhotoSize('../resource/members/thumbs/'.@$showalluser->user_photo.'');?> id="img_cycle3"
                  alt="" /></div>
            </td>
            <td>&nbsp;<span style="font-size:12px; <?php echo $color;?>"><i class="fa fa-circle fa-fw"></i></span>&nbsp;
              <?php echo @$showalluser->name."&nbsp;&nbsp;&nbsp;".$showalluser->lastname;?>
	  ...
	  ?><a
                href="?p=setting_users&e=y&key=<?php echo @$showalluser->user_key;?>" class="btn btn-info btn-xs "><i
                  class="fa fa-edit fa-fw"></i>
                <?php echo @LA_BTN_EDIT;?></a><button type="button" class="btn btn-danger btn-xs " onClick="javascript:deleteUser('<?php echo @$showalluser->user_key;?>');"><i
                  class="fa fa-times fa-fw"></i>
                <?php echo @LA_BTN_DELETE;?></button></td>
          </tr>
          <?php
